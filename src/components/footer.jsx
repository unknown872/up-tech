    ...
    return (
        <footer className="pt-10 bg-gray-800 footer-img bg-cover relative">
            <div className="px-10 md:px-8">
                ...
                <div className="flex-1 mt-16 space-y-6 lg:px-10 justify-between sm:flex md:space-y-0">
                    {
                            ...
                            >
                                ...
                                </h4>
                                {
                                    item.items.map(((el, idx) => (
                                        <li key={idx} data-aos="fade-right" fade-aos-duration="3000">
                                            <div className='flex'>
                ...
                <div data-aos="fade-up" data-aos-duration="1000" className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-gray-300">© 2024 Up-Tech Inc. All rights reserved.</p>
