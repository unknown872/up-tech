                    ...
                    <ul className="grid gap-x-12 divide-y [&>.feature-1]:pl-0 sm:grid-cols-2 sm:gap-y-8 sm:divide-y-0 lg:divide-x lg:grid-cols-3 lg:gap-x-0">
                        {
                            features.map((item, idx) => (
                                <li data-aos="fade-down" data-aos-duration="3000" key={idx} className={`feature-${idx + 1} space-y-3 py-8 lg:px-12 sm:py-0`}>
                                    <div data-aos="fade-right" data-aos-duration="4000" className="w-12 h-12 border text-blue-600 rounded-full flex items-center justify-center">
                                        {item.icon}
                                    </div>
                                    <h4 data-aos="fade-right" data-aos-duration="5000" className="text-gray-800 font-bold text-3xl">
                                        {item.title}
                                    </h4>
