    ...
    return (
        <section className="mx-auto px-4 md:px-8 py-14 bg-beige bg-cover" id="product">
            ...
            <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 gap">
                {
                    posts.map((items, key) => (
                        <article data-aos="zoom-in-down" data-aos-duration="1000" className="max-w-md mx-auto mt-4 shadow-lg border rounded-md duration-300 hover:shadow-xl hover:shadow-blue-500 bg-white" key={key}>
                            <a href={items.href}>
