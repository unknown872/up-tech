...
function page() {
    ...
    const contactMethods = [
        {
            icon:
                <svg aria-label="Phone Icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14">
        ...
        {
            icon:
                <svg aria-label="Email Icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14">
        ...
        {
            icon:
                <svg aria-label="Localisation Icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14">
    ...
    return (
        <>
            <Helmet>
                <title>Contact - UP-TECH</title>
                <meta name="description" content="Contactez UP-TECH pour des services IT à Dakar. Nous fournissons des solutions technologiques pour une transformation digitale sereine." />
                <meta name="keywords" content="UP-TECH, UP TECHNOLOGIE CORPORATION, Contact, transformation digitale, développement de logiciels, fintech, solutions sur mesure" />
                <meta property="og:title" content="Contactez UP-TECH" />
                <meta property="og:description" content="Contactez UP-TECH pour des services IT à Dakar. Nous fournissons des solutions technologiques pour une transformation digitale sereine." />
                        ...
                        <div className="mt-12 max-w-xl" data-aos="fade-right" data-aos-duration="500">
                            ...
                            >
                                <div className="flex flex-col items-center gap-y-5 gap-x-6 [&>*]:w-full sm:flex-row">
                                    <div>
                                        <label htmlFor="firstName" className="text-normal text-gray-600">
                                            Prenom *
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label htmlFor="lastName" className="text-normal text-gray-600">
                                            Nom *
                                        </label>
                                        <input
                                            type="text"
                                ...
                                <div>
                                    <label htmlFor="email" className="text-normal text-gray-600">
                                        Email *
                                    </label>
                                    <input
                                        type="email"
                                ...
                                <div>
                                    <label htmlFor="tel" className="text-normal text-gray-600">
                                        Telephone *
                                    </label>
                                    <input
                                        type="tel"
                                ...
                                <div>
                                    <label htmlFor="message" className="text-normal text-gray-600">
                                        Message *
                                    </label>
                                    <textarea
                                        required
