    ...
    return (
        <div>
            ...
            <section className="bg-beige bg-cover">
                ...
                <div className="lg:flex lg:p-20 p-4 gap-x-14">
                    ...
                    <div className="lg:w-1/2">
                        <div data-aos="fade-right" data-aos-duration="300" className='lg:mt-0 mt-10'>
                            <p className='mt-1 lg:text-normal text-normal text-gray-600'>
                ...
                <div className="lg:mx-10 mx-4 mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 pb-10">
                    {
                        posts.map((items, key) => (
                            <article className="max-w-md mx-auto lg:px-8 pt-5 lg:pb-8  bg-white hover:bg-black hover:bg-opacity-75 mt-4 shadow-lg border rounded-md duration-300 hover:shadow-sm" key={key} data-aos="fade-up">
                                <a href={items.href}>
                                    <div className="group hover:animate-none">
                                        <div className="flex items-center justify-center mt-2 pt-3 ml-4 mr-2">
                                            <div className="flex-none border-dashed border-2 p-4 rounded-full text-blue-950 border-blue-600 group-hover:animate-bounce">
                                                {items.icon}
                                            </div>
                                        </div>
                                        <div className="pt-3 ml-4 mr-2 mb-3 text-center">
                                            <h3 className="text-blue-900 text-2xl font-bold group">
                                                {items.title}
                                            </h3>
